...
public class CouponRepository {
    ...
    public CouponRepository(
        ...
        // COUPON-615. Every entry is checked against Coupon#isWellFormed before the catalogue is
        // published. An entry that fails is a malformed entry, not an entry worth nothing, and a
        // published entry is resolvable — so it would be acted on. Failing here means the fault
        // surfaces when the catalogue is assembled at startup, which is a problem a deploy shows,
        // rather than as a zero-value redemption nobody is alerted to.
    ...
    /**
     * The publication gate — COUPON-615.
     *
     ...
     * carries the catalogue codes, which are published identifiers, and nothing else.
     */
